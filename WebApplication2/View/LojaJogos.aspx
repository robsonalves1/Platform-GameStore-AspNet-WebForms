...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container-fluid">
                ...
                <div id="DivSearchBar" class="d-flex" runat="server">
                    ...
                    <div id="DivIconApagaResultados" runat="server">
                        <button type="button" id="BtnIconApagaResultado" runat="server" onserverclick="BtnIconEraseSearchedList_Click">
        ...
        <%--INVISIBLE LABEL TO SELECT THE ID OF GAME--%>
    ...
    <script src="../Scripts/JavaScriptLojaJogos.js"></script>
